...
image = gradient(exemplos[5], axis='y')
print("OK.")
showImage(image, contadorExemplos= 6)

print("Sobel...")
exemplos.append(Image.open("exemplo7.jpg")) 
image = sobel(exemplos[6])
print("OK.")
showImage(image, contadorExemplos= 7)

print("\n- Filtros demonstrados. Misturando conforme solicitado:")

print("Mistura 1: sobel -> gradiente(eixo Y)")
exemplos.append(Image.open("exemplo8.jpg"))
image = sobel(exemplos[7])
